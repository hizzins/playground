...
const { getAbsPath, rootPath, srcPath, publicPath, distSeminarPath, distRootPath } = require('./path');
...
module.exports = {
  ...
  entry: [
    "@babel/polyfill",
    srcPath + '/apps/seminarRoom/index.js'
  ],

  output: {
    path: distSeminarPath,
    filename: 'bundle.js'
  },
        ...
        use: [
          {
            ...
            options: {
              ...
              outputPath: 'contents/img/', // 개발 버전의 절대 경로와 맞춰 파일을 생성한다.
              name: '[name].[hash].[ext]'
            }
          }
        ]
  ...
  plugins: [
    new CleanWebpackPlugin(['dist-room-seminar/*'], {
      root: distRootPath,
      verbose: true // Write logs to console.
    }),
    new HtmlWebpackPlugin({
      template: "./public/seminar-room.html"
    }),
