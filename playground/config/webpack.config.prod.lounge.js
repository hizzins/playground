...
const { getAbsPath, rootPath, srcPath, publicPath, distPath, distRootPath } = require('./path');
        ...
        use: [
          {
            ...
            options: {
              ...
              publicPath: '/public/service/dist-react/contents/img/', // for JSX에서 불리는 이미지는 절대 경로를 잡아야 한다 or CDN
              name: '[name].[hash].[ext]'
            }
          }
        ]
